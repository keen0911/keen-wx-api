package com.example.keen.wx.controller;

import com.example.keen.wx.common.util.R;
import com.example.keen.wx.config.shiro.JwtUtil;
import com.example.keen.wx.controller.form.DeleteMessageRefByIdForm;
import com.example.keen.wx.controller.form.SearchMessageByIdForm;
import com.example.keen.wx.controller.form.SearchMessageByPageForm;
import com.example.keen.wx.controller.form.UpdateUnreadMessageForm;
import com.example.keen.wx.service.MessageService;
...
public class MessageController {
    ...
    public R refreshMessage(@RequestHeader("token") String token){
        int userId=jwtUtil.getUserId(token);
        Integer integer = messageTask.receiveAsync(userId + "");
